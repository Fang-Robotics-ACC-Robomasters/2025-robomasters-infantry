# 2025-robomasters-infantry
Control Code for Robomasters Infantry
[![pipeline status](https://gitlab.com/aruw/controls/infantry/badges/develop/pipeline.svg)](https://gitlab.com/aruw/controls/infantry/-/commits/develop)
...
```
cd my-amazing-project/infantry-project
pipenv shell
# Build for hardware
scons build
# Run automated tests
...
1. Make sure you have VSCode opened in the folder `infantry` (**not
   `infantry-project`**)
...
1. Open the folder `aruw-infantry-project` in VSCode. Hit the debug tab on the left side or type
...
`/infantry-project/robot-type/robot_type.hpp` and change the macro defined in this file.
...
The below commands require that your working directory is `/infantry-project` (where the
